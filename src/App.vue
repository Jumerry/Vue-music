<template>
    <div id="app">
        <div class="header">
            <van-nav-bar title="幻 听">
                <template #right>
                    <van-icon name="search" size="20" @click="openSearchPage"/>
                </template>
            </van-nav-bar>
            <van-tabs v-model="activeName">
                <van-tab title="推荐" name="推荐"></van-tab>
                <van-tab title="歌手" name="歌手"></van-tab>
                <van-tab title="排行" name="排行"></van-tab>
            </van-tabs>
        </div>
